...
public class LinkedListDice implements Dice {
    private int number_of_rolls;

    public LinkedListDice(int number_of_rolls) {
    ...
    public String toString() {
        int sum = 0;
        String result = "Linked List Implementation: Roll " + number_of_rolls + " time(s)\n";
